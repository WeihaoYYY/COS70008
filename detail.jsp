...
<head>
    ...
    <script type= text/javascript>
		...
		window.open(url, 'newwindow', 'width=500,height=500,screenX=300,screenY=100');
    	}
    </script>
</head>
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link" href="${pageContext.request.contextPath}/item/admin">Admin Login</a>
                </li>
                <li class="nav-item">
			...
			<c:forEach items="${list}" var="ad" >  <!--varStatus获取索引-->
				<tr class="body">
					<td class="pic">
						...
						<c:choose>
							<c:when test="${(fileFormatLc eq jspFormat) || (fileFormatLc eq pngFormat)}">
								<a onclick="openFile('${ad.file_path}'); return false;"><img src="${ad.file_path}" title="Click to view"></a>
							</c:when>
							<c:otherwise>
								<a onclick="openFile('${ad.file_path}'); return false;"><img src="documentImage.png" class="notImage" title="Click to view"></a>
							</c:otherwise>
						</c:choose>
						...
						<div>
							<table>
								...
								<tr>
									...
									<td>${ad.creator}</td>
									<td class="label">Creator email:</td>
