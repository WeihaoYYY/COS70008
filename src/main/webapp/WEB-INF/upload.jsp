...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <!-- <form class="d-flex">
<%--        <form:input class="form-control me-2" type="search" placeholder="Search" aria-label="Search">--%>
...
<form:form action="save" method="post" modelAttribute="Item">
  ...
  <form:input type="file" path="file_path" id="file" />
  <select
          name="type"
  ...
  >
    ...
    <option value="Sales">Photos</option>
    <option value="Article & Journal & Newspaper">News</option>
...
<%--  <form:input type="file" class="form-control" id="inputGroupFile02" />--%>
